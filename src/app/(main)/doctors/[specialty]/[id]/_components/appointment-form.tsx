...
import { SlotItem } from "@/lib/types";

export function AppointmentForm({ doctorId, slot, onBack, onComplete }:{doctorId:string, slot:SlotItem,onBack:()=>void,onComplete:()=>void}) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20 space-y-3">
        ...
        <div className="flex items-center">
          ...
          <span className="">{slot.formatted}</span>
        </div>
        <div className="flex items-center">
