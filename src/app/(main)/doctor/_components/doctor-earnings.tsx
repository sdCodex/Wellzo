...
import { Earnings,Payouts } from "@/lib/types";

export function DoctorEarnings({ earnings, payouts = [] }:{earnings:Earnings,payouts:Payouts[]}) {
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                <Badge
                  variant="outline"
                  className="bg-amber-300/20 border-amber-900/30 text-amber-400"
                >
                  PROCESSING
                </Badge>
              ) : (
                <Badge
                  variant="outline"
                  className="bg-emerald-300/20 border-emerald-900/30 text-emerald-400"
                >
                  Available
                </Badge>
              )}
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              <div className="flex justify-between">
                ...
                <span className="">{availableCredits}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="">-${platformFee.toFixed(2)}</span>
              </div>
